...
using Badmati.BinarySpace.Services;
using System;
...
namespace WxPayAPI
{
    ...
    public class WxPayData
    {
        ...
        public WxPayData(string securityKey)
        {
        ...
        **/
        public string ToXml()
        {
            ...
            if (0 == m_values.Count)
            {
                return string.Empty;//throw new WxPayException("WxPayData数据为空!");
            }
        ...
        */
        ...
        public string MakeSign()
        {
            ...
            string str = ToUrl();
            //在string后加入API KEY
            str += "&key=" + _securityKey;//ConstDefine.TRADE_KEY;
            //MD5加密
