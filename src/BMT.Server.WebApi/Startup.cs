...
using BMT.Server.Services.AppService;
using BMT.Server.Services.IAppService;
using BMT.Server.WebApi.Middleware;
using StackExchange.Exceptional.Stores;
using BMT.Server.Infrastructure;
using BMT.Server.Infrastructure.AutoFac;
using BMT.Server.WebApi.HostService;
using BMT.Server.WebApi.Filters;
using Swashbuckle.AspNetCore.Swagger;
using BMT.Server.WebApi.Controllers;
using Microsoft.AspNetCore.Http;
using Dapper;
using BMT.Server.Services.IRefresh;
using BMT.Server.Infrastructure.Quartz;
using BMT.Server.WebApi.TaskJob;
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            */
            ...
            //BMTRedisHelper.Initialization(Configuration["RedisConStr"],Configuration["prefix"]);
            //添加swagger json 支持
#if DEBUG
        ...
        private void RegisterIOC(ContainerBuilder containerBuilder)
        {
            ...
            foreach (var item in Directory.GetFiles(path, "BMT*.dll"))
            {
